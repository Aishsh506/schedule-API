...
namespace ScheduleDAL.Migrations
{
    ...
    [Migration("20231012115919_AddBookingLessons")]
    partial class AddBookingLessons
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScheduleDAL.Entities.BookedLesson", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("BookedLessons", t =>
                        {
                            t.HasCheckConstraint("Timeslot", "Timeslot > 0 AND Timeslot < 8");
                        });
                });

            modelBuilder.Entity("ScheduleDAL.Entities.BookedLessonGroup", b =>
                {
                    b.Property<Guid>("BookedLessonId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("GroupId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("BookedLessonId", "GroupId");

                    b.HasIndex("GroupId");

                    b.ToTable("BookedLessonGroups");
                });
            ...
            modelBuilder.Entity("ScheduleDAL.Entities.Lesson", b =>
                {
                    ...
                    b.ToTable("Lessons", t =>
                        {
                            t.HasCheckConstraint("DayOfWeek", "DayOfWeek > 0 AND DayOfWeek < 6");

                            t.HasCheckConstraint("StartDate", "StartDate <= EndDate");
            ...
            modelBuilder.Entity("ScheduleDAL.Entities.BookedLessonGroup", b =>
                {
                    b.HasOne("ScheduleDAL.Entities.BookedLesson", "BookedLesson")
                        .WithMany()
                        .HasForeignKey("BookedLessonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
